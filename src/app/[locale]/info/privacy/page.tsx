          ...
          {[{
            ...
            content: (
              <ul className="list-disc list-inside space-y-2 text-sm text-[var(--foreground)]">
                <li><strong>Proveer el servicio:</strong> conectar con profesionales verificados.</li>
                <li><strong>Procesar pagos:</strong> facilitar transacciones seguras.</li>
                <li><strong>Mejorar la plataforma:</strong> optimizar funciones y experiencia.</li>
                <li><strong>Comunicación:</strong> enviar confirmaciones y avisos.</li>
                <li><strong>Seguridad:</strong> prevenir fraude y proteger la comunidad.</li>
              </ul>
            )
          },{
            index: "3",
            ...
            content: (
              <div className="grid md:grid-cols-2 gap-3 mt-4">
                {["Encriptación SSL/TLS","Servidores Seguros","Autenticación de Dos Factores","Monitoreo Constante"].map((item, i) => (
                  <div key={i} className="flex items-center gap-2 bg-[var(--light-gray)] p-2 rounded-lg shadow-sm">
            ...
            <SectionBlock key={idx} index={section.index} title={section.title} borderColor="var(--primary)" gradient="from-[var(--primary)] to-[var(--primary)]">
              {section.content}
            </SectionBlock>
          ))}
