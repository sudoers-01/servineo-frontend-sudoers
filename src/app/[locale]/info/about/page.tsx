      ...
      <section className="relative bg-[var(--primary)] text-white py-16 px-6 md:px-12 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg md:text-xl opacity-90 max-w-3xl mx-auto">
            En <span className="font-bold">Servineo</span> combinamos tecnología, confianza
            y talento profesional para transformar la manera en que las personas
            contratan servicios en su hogar o negocio.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto py-14 px-6 md:px-10">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-base text-gray-700 leading-relaxed mb-4">
              Nuestra misión es eliminar la incertidumbre al contratar servicios.
              Ya no necesitas depender de recomendaciones informales ni asumir riesgos:
              con Servineo encuentras profesionales calificados en pocos minutos,
              con información clara, valoraciones reales y precios transparentes.
            </p>

            <p className="text-base text-gray-700 leading-relaxed">
              Cada proveedor pasa por un proceso de verificación que valida identidad,
              experiencia y antecedentes, asegurando que cada servicio contratado
              cumpla nuestros estándares de excelencia.
            </p>
          </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed">
                    ...
                    innecesarias y recibe confirmaciones automáticas para evitar retrasos
                    o cancelaciones inesperadas.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-[var(--primary)]">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed">
                    Envía un video breve mostrando el problema y recibe presupuestos
                    personalizados de profesionales interesados, ahorrando tiempo
      ...
      <section className="max-w-6xl mx-auto py-14 px-6 md:px-10">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-base text-gray-700 leading-relaxed mb-4">
              Facilitar el acceso a servicios profesionales confiables mediante una
              plataforma segura, intuitiva y accesible para todos.
            </p>

            <p className="text-base text-gray-700 leading-relaxed">
              Trabajamos continuamente para mejorar la experiencia tanto del cliente
              como del proveedor, impulsando una comunidad basada en respeto,
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center bg-white/10 p-6 rounded-lg">
              ...
              <p className="text-white/90 text-sm leading-relaxed">
                Seguridad y transparencia en cada interacción
                entre clientes y profesionales.
              </p>
            </div>
            ...
            <div className="text-center bg-white/10 p-6 rounded-lg">
              ...
              <p className="text-white/90 text-sm leading-relaxed">
                Seleccionamos expertos comprometidos con la excelencia
            ...
            <div className="text-center bg-white/10 p-6 rounded-lg">
              ...
              <p className="text-white/90 text-sm leading-relaxed">
                Utilizamos tecnología para simplificar,
                agilizar y optimizar la contratación de servicios.
              </p>
            </div>
          </div>
