          ...
          {[
            {
              ...
              content: (
                <>
                  <p>Servineo conecta usuarios con profesionales de servicios verificados. Al utilizar la plataforma, te comprometes a:</p>
            ...
            },
            {
              ...
              content: (
                <p>
                  Todo el contenido de Servineo, incluyendo textos, logos, gráficos y software, es propiedad de la empresa o de terceros con licencia.
                </p>
              ),
            },
            {
              ...
              content: (
                <p>
                  Servineo no se hace responsable por daños directos o indirectos derivados del uso de la plataforma.
                </p>
              ),
            },
            {
            ...
            <SectionBlock key={idx} index={term.index} title={term.title} borderColor="var(--primary)">
              {term.content}
            </SectionBlock>
          ))}
        </div>
