    ...
    <main className="max-w-4xl mx-auto p-6 md:p-12">
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          usuario reconoce que Servero no presta directamente los servicios, sino que actúa
          únicamente como intermediario digital.
        </p>
        <p>
          Cada usuario es responsable de la veracidad de la información que proporciona. Queda
          prohibido usar la plataforma para fines ilícitos, fraudulentos o contrarios al orden
          público.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          la aplicación, la gestión de cuentas y la conexión entre requesters y fixers. Servero se
          compromete a proteger la información del usuario, pero no se responsabiliza por accesos no
          autorizados derivados de negligencia del propio usuario (ejemplo: compartir contraseñas).
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          distribuir ni usar con fines comerciales ningún elemento de la plataforma sin autorización
          expresa.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          trabajos recae exclusivamente en los proveedores y los usuarios que los contraten. Servero
          no se hace responsable por daños, pérdidas o conflictos que puedan surgir entre usuarios y
          proveedores.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          tribunales competentes en dicho país.
        </p>
      </section>
