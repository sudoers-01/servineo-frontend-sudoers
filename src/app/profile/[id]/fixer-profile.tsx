    ...
    <div className="w-full bg-white rounded-2xl shadow-lg border border-gray-200 text-black p-8">
      {data ? (
          ...
          <div className="md:flex md:flex-row-reverse justify-between w-full">
            <div className="flex flex-col items-center">
              {!data.photo_url ? (
                ...
                <img src={data.photo_url} alt={data.name} className="w-24 h-24 rounded-full object-cover" />
              )}

              <div className="flex gap-2 mb-4">
                {[1, 2, 3].map((star) => (
                  <svg key={star} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star-icon lucide-star w-6 h-6">
        ...
        <div className="flex items-center justify-center py-10">
          <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-loader-circle-icon lucide-loader-circle animate-spin ">
