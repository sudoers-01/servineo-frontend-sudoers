    ...
    <main className="min-h-screen bg-white px-6 py-10 font-['Roboto']">
      <div className='max-w-4xl mx-auto'>
        ...
        <div className='flex items-center gap-2 mb-10'>
          <button onClick={() => router.back()} className='text-[#111827] hover:underline text-sm'>
            ← Servineo
          </button>
        </div>

        {/* Título */}
        <h1 className='text-center text-lg font-semibold text-[#111827] mb-6'>Jobs Comments</h1>
              ...
              <div className='flex'>
                {[...Array(3)].map((_, i) => (
                  <Star
                    ...
                    size={18}
                    className={
                      i < comment.rating ? 'text-[#FACC15] fill-[#FACC15]' : 'text-gray-300'
                    }
                  />
                ))}
              </div>
