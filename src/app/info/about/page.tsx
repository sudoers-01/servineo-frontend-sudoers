  ...
  return (
    ...
    <div className="bg-background text-foreground min-h-screen font-sans">
      ...
      <section className="relative bg-gradient-to-br from-primary/90 to-primary text-white py-12 px-6 md:px-12 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-60 h-60 bg-primary/25 rounded-full blur-2xl"></div> {/* Usa primary/25 */}
      ...
      <section className="max-w-6xl mx-auto py-10 px-6 md:px-10 space-y-8">
        {/* Introducción */}
        <div className="bg-card p-6 rounded-xl shadow-lg border-l-4 border-primary"> {/* Usa bg-card y border-primary */}
          <h2 className="text-2xl font-bold text-primary mb-3"> {/* Usa text-primary */}
            Información General
          </h2>
              ...
              <div className="ml-4 mt-4 space-y-3 p-4 bg-muted rounded-xl border border-primary/50"> 
                {section.details.map((detail, dIndex) => (
                  <div key={dIndex} className="text-sm text-foreground">
                    <p className="font-semibold text-primary">{detail.subtitle}:</p> {/* Usa text-primary */}
                    <p className="leading-relaxed pl-3 border-l-2 border-primary/50 ml-1"> {/* Usa border-primary/50 */}
                      {detail.text}
                    </p>
                  </div>
                ))}
