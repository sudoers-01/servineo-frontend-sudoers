        ...
        <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-x-6 gap-y-2 mt-3 text-sm text-gray-500">
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <span>{t('card.issued')}: {new Date(cert.issueDate).toLocaleDateString()}</span>
                                        </div>
                                        <div className="flex items-center gap-1.5">
                                            <Calendar className="h-4 w-4" />
                                            <span>{t('card.expires')}: {new Date(cert.expiryDate).toLocaleDateString()}</span>
                                        </div>
                                    </div>
            ...
            >
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">{t('form.institution.label')}</label>
                        <input
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">{t('form.issueDate.label')} </label>
                            <input
                                type="date"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">{t('form.expiryDate.label')}</label>
                            <input
                                type="date"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">{t('form.credentialId.label')}</label>
                            <input
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">{t('form.credentialUrl.label')}</label>
                            <input
